 ...
 */
public class JSONRenderer implements JSONEventRenderer {
    private static final Log log = LogFactory.getLog(JSONRenderer.class);
    ...
    private static OutputValueRenderer outRenderer;
     ...
     */
    public JSONRenderer(EventType eventType, JSONRenderingOptions options)
    {
        ...
        rendererOptions = new RendererMetaOptions(true, false, propertyRenderer, propertyRendererContext);
            ...
            else
            {
                ...
                else
                {
                    ...
                    for (;it.hasNext();)
                    {
                        ...
                        {
                            outRenderer = new OutputValueRendererJSONString();
                            if (rendererOptions.getRenderer() == null) {
